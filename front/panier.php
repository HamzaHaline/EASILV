...
<div class="container py-2">
    ...
    if (isset($_GET['success'])) {
        ...
        Your order with the amount <strong>(<?php echo $_GET['total'] ?? 0 ?>)</strong> <i class="fa fa-solid fa-dollar"></i> est bien ajoutée.
        </div>
        <hr>
        <?php
    }
    if (!isset($_GET['success'])) {
        ...
        ?>
        <h4>Cart (<?php echo $productCount; ?>)</h4>
        <?php
    }
    ?>
    <div class="container">
            ...
            if (empty($panier)) {
                if (!isset($_GET['success'])) {
                    ...
                    <div class="alert alert-warning" role="alert">
                        Your cart is empty !
                        Start Shopping ! <a class="btn btn-success btn-sm" href="./index.php">Buy Products</a>
                    </div>
                    <?php
                }
            } else {
